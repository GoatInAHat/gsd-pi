...
const SUBCOMMAND_HELP: Record<string, string> = {
  ...
  headless: [
    ...
    '  discard-milestone    Delete DB-only reservations (requires --orphan-only)',
    '',
    'new-milestone flags:',
    ...
    '  gsd headless discard-milestone M015 --orphan-only   Delete a verified orphan reservation',
    '',
